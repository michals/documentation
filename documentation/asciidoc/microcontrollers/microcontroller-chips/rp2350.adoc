...
Raspberry Pi offers the following design files for the RP2350 microcontroller:

* https://pip.raspberrypi.com/documents/RP-010328-CA[RP2350A Minimal Viable Board] (KiCad), a reference for creating a minimal RP2350A board.
* https://pip.raspberrypi.com/documents/RP-010329-CA[RP2350B Minimal Viable Board] (KiCad), a reference for creating a minimal RP2350B board.
